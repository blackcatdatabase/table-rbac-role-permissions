...
namespace BlackCat\Database\Packages\RbacRolePermissions;
...
use BlackCat\Database\Packages\RbacRolePermissions\Repository\RbacRolePermissionRepository as GeneratedRepository;
...
{
  private RbacRolePermissionRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof RbacRolePermissionRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected RbacRolePermissionRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\RbacRolePermissions\Dto\RbacRolePermissionDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\RbacRolePermissions\Dto\RbacRolePermissionDto|null { return $this->repo->getById($id, $asDto); }

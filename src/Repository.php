...
use BlackCat\Database\Packages\RbacRolePermissions\Repository\RbacRolePermissionRepository;
...
{
    private RbacRolePermissionRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new RbacRolePermissionRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\RbacRolePermissions\Dto\RbacRolePermissionDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\RbacRolePermissions\Dto\RbacRolePermissionDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\RbacRolePermissions\Dto\RbacRolePermissionDto|null
    {

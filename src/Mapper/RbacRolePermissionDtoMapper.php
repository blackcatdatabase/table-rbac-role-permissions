...
namespace BlackCat\Database\Packages\RbacRolePermissions\Mapper;

use BlackCat\Database\Packages\RbacRolePermissions\Dto\RbacRolePermissionDto;
use BlackCat\Database\Packages\RbacRolePermissions\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO RbacRolePermissionDto:
 ...
 */
final class RbacRolePermissionDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'role_id' => 'roleId', 'permission_id' => 'permissionId', 'effect' => 'effect', 'source' => 'source', 'created_at' => 'createdAt' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'role_id', 'permission_id' ];
    /** @var string[] */
     ...
     * @return RbacRolePermissionDto
     */
    public static function fromRow(array $row): RbacRolePermissionDto
    {
        /** @var RbacRolePermissionDto */
        return DtoHydrator::fromRow(
            RbacRolePermissionDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?RbacRolePermissionDto
    {
     ...
     *
     * @param RbacRolePermissionDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(RbacRolePermissionDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(RbacRolePermissionDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(RbacRolePermissionDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,RbacRolePermissionDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,RbacRolePermissionDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(RbacRolePermissionDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,RbacRolePermissionDto>
     */

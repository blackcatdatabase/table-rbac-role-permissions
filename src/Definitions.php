...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'rbac_role_permissions'; }
    public static function contractView(): string { return 'vw_rbac_role_permissions'; }
    /** @return string[] */
    public static function columns(): array { return [ 'role_id', 'permission_id', 'effect', 'source', 'created_at' ]; }
     ...
     * role_id permission_id may be "id" or "col1, col2".
     * @return string[]
     */
    public static function pkColumns(): array {
        $raw = trim('role_id permission_id');
        if ($raw === '') {
            throw new \InvalidArgumentException('Definitions::pkColumns(): token role_id permission_id must not be empty.');
        }
    ...
    public static function defaultOrder(): ?string {
        $c = trim('created_at DESC, role_id permission_id DESC'); return $c !== '' ? $c : null;
    }

    /** @return array<int,array<int,string>> list of unique keys */
    public static function uniqueKeys(): array { return [ [ 'role_id', 'permission_id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'role_id', 'permission_id' ]; }

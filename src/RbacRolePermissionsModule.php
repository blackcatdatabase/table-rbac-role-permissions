...
final class RbacRolePermissionsModule implements ModuleInterface
{
    public function name(): string { return 'table-rbac_role_permissions'; }
    public function table(): string { return 'rbac_role_permissions'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-permissions', 'table-rbac_roles' ]; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedFk  = [ 'fk_rbac_rp_perm', 'fk_rbac_rp_role' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [],
            'foreignKeys' => [ 'fk_rbac_rp_perm', 'fk_rbac_rp_role' ],
        ];
    }
}

...
- Pkg folder: [packages\rbac-role-permissions](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\rbac-role-permissions)
...
graph LR
  ...
  rbac_role_permissions["rbac_role_permissions"]:::center
  rbac_role_permissions -->|FK| permissions["permissions"]:::link
  rbac_role_permissions -->|FK| rbac_roles["rbac_roles"]:::accent
...
- Outbound (depends on): "permissions", "rbac_roles"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package rbac-role-permissions -Apply

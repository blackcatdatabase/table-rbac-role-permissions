...
| Pkg folder | [packages/rbac-role-permissions](https://github.com/blackcatacademy/blackcat-database/blob/main/packages/rbac-role-permissions) | Repo location |
...
pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package rbac-role-permissions -Apply
